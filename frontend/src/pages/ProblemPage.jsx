...
import { useProblemById, useAllProblems } from "../hooks/useProblems.js";
...
function ProblemPage() {
  ...
  const { data: currentProblem, isLoading, isError } = useProblemById(id);
  const { data: allProblems = [] } = useAllProblems();
