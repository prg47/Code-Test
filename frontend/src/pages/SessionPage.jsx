...
import { useProblemById } from "../hooks/useProblems.js";
...
function SessionPage() {
    ...
    // fetch problem data using problemId stored in session
    const { data: problemData } = useProblemById(session?.problemId);
