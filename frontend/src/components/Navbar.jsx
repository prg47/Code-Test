...
function Navbar(){
    ...
    return(
        <nav className="bg-base-100/80 backdrop-blur-md border-primary/20 sticky top-0
        z-50 shadow-lg">
            <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    <Link to={"/problems"}
                    className={`px-4 py2.5 rounded-lg transition-all duration-200
                     ...
                     `}>
                        <div className="flex items-center gap-x-2.5">
                            ...
                            <span className="font-md hidden sm:inline">
                                Problems
                            </span>
                        </div>
                    </Link>
